...
class ParrotCommandSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'title', 'category', 'tag', 'perform_time', 'priority', 'parrot_0', 'parrot_1')
        read_only_fields = ('id', 'name', 'title', 'category', 'tag', 'perform_time', 'priority', 'parrot_0', 'parrot_1')
